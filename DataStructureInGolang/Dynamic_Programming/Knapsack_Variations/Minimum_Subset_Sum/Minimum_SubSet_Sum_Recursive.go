...
func findMinSubSetSum(arr []int, n, totalSum, calculatedSum int) int {
	...
	//If we've reached last element. Sum of one subset is sumcalculated and sum of other subset is [sumTotal-sumCalculated]. Then return absolute difference of two sums.
	if n == 0 {
